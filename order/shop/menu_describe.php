	...
	<div class="content">	
		...
		<form action="mod/regist_menu_describe.php" method="post" enctype="multipart/form-data">
			...
			<div>
				...
				<input type="text" maxlength="100" size="50" name="menu_name" value="<?php echo $col["menu_name"] ?>">
			</div>
			<div>
				<label for="">値段　入力</label>
				<input type="number" name="menu_price" style="width:4em" value="<?php echo $col["menu_price"] ?>" >円
			</div>
			<div>
				<label for="">紹介文 入力</label>
				<textarea name="menu_text" id="" cols="50" rows="10"><?php echo $col["menu_text"] ?></textarea>
			</div>
			<div>
				<button>保存</button>
			</div>
